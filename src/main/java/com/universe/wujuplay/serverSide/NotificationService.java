package com.universe.wujuplay.serverSide;
...
public class NotificationService {
    ...
    public SseEmitter subscribe(Long userId) {
        ...
        sendToClient(userId, "EventStream Created. [userId=" + userId + "]", "sub");
        return emitter;
    }
    ...
    public void notify(Long userId, Object event) {
        sendToClient(userId, event, "message");
    }

    public void notifyMergeRequests(Long userId, Object event) {
        sendToClient(userId, event, "mergeRequest");
    }
    /**
     * 클라이언트에게 데이터를 전송
     *
